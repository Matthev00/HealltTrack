...
DROP TABLE GOAL;
DROP TABLE FOOD;
DROP TABLE BODY_MEASUREMENT_ENTRY;
...
ALTER TABLE activity_entry ADD CONSTRAINT activity_entry_unique_date UNIQUE ( date_time );
...
ALTER TABLE meal ADD CONSTRAINT positive_protein CHECK ( proteins >= 0 );

ALTER TABLE meal ADD CONSTRAINT positive_fats CHECK ( fats >= 0 );

ALTER TABLE meal ADD CONSTRAINT positive_carbohydrates CHECK ( carbohydrates >= 0 );
